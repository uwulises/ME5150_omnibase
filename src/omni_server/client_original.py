...
def main():
    server_url = 'ws://192.168.0.103'  # Replace with the WebSocket server URL
    #server_url = 'ws://192.168.0.101:8765'  # Replace with the WebSocket server URL
    server_url = 'ws://omni' #'ws://omni2.local:8765'
    server_address = 'omni'  # Replace with the IP/hostname address of your Raspberry Pi
    server_port = 5000
